<?php
    ...
    $sql = "create table userTable (uid int PRIMARY KEY, nickname varchar(20) not null, gender varchar(20) not null, score int not null, setting varchar(40) not null, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP)";
