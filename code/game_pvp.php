            ...
            <div class="board-column">
                <div class="player-info player-white">
                    <div class="profile-details">
                        <h2 id="opponent-name-game">상대방 (백돌)</h2>
                        <div id="opponent-rank-game" class="rank-info">-</div>
                    </div>
                ...
                <div class="player-info player-black">
                    <div class="profile-details">
                        ...
                        <div id="player-rank-game" class="rank-info">-</div>
                    </div>
    ...
    <div id="end-game-modal" class="modal-overlay">
        <div class="modal-content">
            ...
            <div class="modal-buttons">
                <button id="rematch-pvp-button" class="btn-primary">재시합 요청</button>
                <button id="modal-home-button" class="btn-secondary">홈으로 가기</button>
            </div>
        </div>
    </div>
    <script src="game_pvp.js"></script>
</body>
</html>